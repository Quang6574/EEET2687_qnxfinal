...
void* OnPeakSM(void *arg) {
	...
	while(Onpeak_SM_living) {
		...
		case EWG_NSR:
			...
			// Ping CTRL Node
			pingmsg = Msg_craft(MSG, PING, I2, EWG_NSR);
			Msg_send((Msg*) &pingmsg, I2_id, CTL_server_coid);
		...
		case EWY_NSR:
			...
			// Ping CTRL Node
			pingmsg = Msg_craft(MSG, PING, I2, EWY_NSR);
			Msg_send((Msg*) &pingmsg, I2_id, CTL_server_coid);
		...
		case EWR_NSR_1:
			...
			// Ping CTRL Node
			pingmsg = Msg_craft(MSG, PING, I2, EWR_NSR_1);
			Msg_send((Msg*) &pingmsg, I2_id, CTL_server_coid);
		...
		case EWR_NSG:
			...
			// Ping CTRL Node
			pingmsg = Msg_craft(MSG, PING, I2, EWR_NSG);
			Msg_send((Msg*) &pingmsg, I2_id, CTL_server_coid);
		...
		case EWR_NSY:
			...
			// Ping CTRL Node
			pingmsg = Msg_craft(MSG, PING, I2, EWR_NSY);
			Msg_send((Msg*) &pingmsg, I2_id, CTL_server_coid);
		...
		case EWR_NSR_2:
			...
			// Ping CTRL Node
			pingmsg = Msg_craft(MSG, PING, I2, EWR_NSR_2);
			Msg_send((Msg*) &pingmsg, I2_id, CTL_server_coid);
