...
void *TrafficLightSM(void* arg) {
	...
	while (Offpeak_SM_living) {
		...
		case EWG_NSR:
			...
			pingCTRL = Msg_craft(MSG, PING, I2, EWG_NSR);
			Msg_send((Msg *) &pingCTRL, I2_id, CTL_server_coid);
			...
			alert = Msg_craft(MSG, LSRM, I2, EWY_NSR);
			Msg_send((Msg *) &alert, I2_id, I1_server_coid);
			Msg_send((Msg *) &alert, I2_id, TR_server_coid);
		...
		case EWY_NSR:
			...
			// Send ping message to CTRL Node
			pingCTRL = Msg_craft(MSG, PING, I2, EWY_NSR);
			Msg_send((Msg *) &pingCTRL, I2_id, CTL_server_coid);
			sleep(3);
		...
		case EWR_NSR_1:
			...
			// Send ping message to CTRL Node
			pingCTRL = Msg_craft(MSG, PING, I2, EWR_NSR_1);
			Msg_send((Msg *) &pingCTRL, I2_id, CTL_server_coid);
			sleep(1);
		...
		case EWR_NSG:
			...
			pingCTRL = Msg_craft(MSG, PING, I2, EWR_NSG);
			Msg_send((Msg *) &pingCTRL, I2_id, CTL_server_coid);
			...
			alert = Msg_craft(MSG, LSRM, I2, EWR_NSY);
			Msg_send((Msg *) &alert, I2_id, I1_server_coid);
			Msg_send((Msg *) &alert, I2_id, TR_server_coid);
		...
		case EWR_NSY:
			...
			sleep(3);
			// Send ping message to CTRL Node
			pingCTRL = Msg_craft(MSG, PING, I2, EWR_NSY);
			Msg_send((Msg *) &pingCTRL, I2_id, CTL_server_coid);
		...
		case EWR_NSR_2:
			...
			sleep(1);
			// Send ping message to CTRL Node
			pingCTRL = Msg_craft(MSG, PING, I2, EWR_NSR_2);
			Msg_send((Msg *) &pingCTRL, I2_id, CTL_server_coid);
